        ...
        <div>
                        ...
                        <div className="col-lg-3">
                            <a href="#" className="clutch-widget d-flex mb-4 mb-lg-0">
                                <span className="me-2">
                                    ...
                                    <img src="/src/assets/images/images2/clutch.svg" alt width={82} />
                                </span>
                                <span className="d-flex flex-column justify-content-between">
                                    <img src="/src/assets/images/images2/star.png" alt width={90} />
                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-lg-4">
                            <div className="services-card">
                                <div className="service-icon">
                                    <img src="/src/assets/images/images2/cms-setup.png" alt />
                                </div>
                        ...
                        <div className="col-lg-4">
                            <div className="services-card">
                                <div className="service-icon">
                                    <img src="/src/assets/images/images2/psd-to-wordpress.png" alt />
                                </div>
                                <h6 className="service-title">
                        ...
                        <div className="col-lg-4">
                            <div className="services-card">
                                <div className="service-icon">
                                    <img src="/src/assets/images/images2/web-custom-development.png" alt />
                                </div>
                                <h6 className="service-title">
                                    Custom PrestaShop
                                    Website Development
                        ...
                        <div className="col-lg-4">
                            <div className="services-card">
                                <div className="service-icon">
                                    <img src="/src/assets/images/images2/web-development.png" alt />
                                </div>
                                <h6 className="service-title">
                        ...
                        <div className="col-lg-4">
                            <div className="services-card">
                                <div className="service-icon">
                                    <img src="/src/assets/images/images2/plugin.png" alt />
                                </div>
                                <h6 className="service-title">
                        ...
                        <div className="col-lg-4">
                            <div className="services-card">
                                <div className="service-icon">
                                    <img src="/src/assets/images/images2/maintenance.png" alt />
                                </div>
                                <h6 className="service-title">
                        ...
                        <div className="col-lg-4">
                            <div className="services-card">
                                <div className="service-icon">
                                    <img src="/src/assets/images/images2/woo-commerce.png" alt />
                                </div>
                                <h6 className="service-title">
                        ...
                        <div className="col-lg-4">
                            <div className="services-card">
                                <div className="service-icon">
                                    <img src="/src/assets/images/images2/blog.png" alt />
                                </div>
                                <h6 className="service-title">
                                    PrestaShop Blog
                                    Development Service
                        ...
                        <div className="col-lg-4">
                            <div className="services-card">
                                <div className="service-icon">
                                    <img src="/src/assets/images/images2/api.png" alt />
                                </div>
                                <h6 className="service-title">
                ...
                <div className="row m-0">
                    <div className="col-lg-6 p-0">
                        <div className="image-with-text-image">
                            <img src="/src/assets/images/images2/Prestashop-1.png" alt />
                        </div>
                    </div>
                    <div className="col-lg-6 p-0">
            ...
            <div className="image-with-text reverse">
                <div className="row m-0">
                    <div className="col-lg-6 p-0">
                        <div className="image-with-text-image">
                            <img src="/src/assets/images/images2/Prestashop-2.png" alt />
                        </div>
                    </div>
                    <div className="col-lg-6 p-0">
                        <div className="image-with-text-text">
                    ...
                    <div className="row">
                        <div className="col-lg-3">
                            <div className="process-card">
                                <img src="/src/assets/images/images2/reauirement-gathering.png" alt />
                                <h6>1. Gathering requirements</h6>
                            </div>
                        </div>
                        <div className="col-lg-3">
                            <div className="process-card">
                                <img src="/src/assets/images/images2/uiux.png" alt />
                                <h6>2. UI/UX Design</h6>
                            </div>
                        </div>
                        <div className="col-lg-3">
                            <div className="process-card">
                                <img src="/src/assets/images/images2/prototype.png" alt />
                                <h6>3. Static Prototype</h6>
                            </div>
                        </div>
                        <div className="col-lg-3">
                            <div className="process-card">
                                <img src="/src/assets/images/images2/dynamic-development.png" alt />
                                <h6>4. Dynamic Development</h6>
                            </div>
                        </div>
                        <div className="col-lg-4">
                            <div className="process-card">
                                <img src="/src/assets/images/images2/testing.png" alt />
                                <h6>5. Quality Assurance</h6>
                            </div>
                        </div>
                        <div className="col-lg-4">
                            <div className="process-card">
                                <img src="/src/assets/images/images2/live-development.png" alt />
                                <h6>6. Live Deployment </h6>
                            </div>
                        </div>
                        <div className="col-lg-4">
                            <div className="process-card">
                                <img src="/src/assets/images/images2/question.png" alt />
                    ...
                    <div className="row">
                        <div className="col-lg-4 project" data-category="ecommerce-development">
                            <div className="work-card">
                                <img src="/src/assets/images/ourwork/New-Project-1-1024x1024.jpg" alt className="work-image" />
                        ...
                        <div className="col-lg-4 project" data-category="web-development">
                            <div className="work-card">
                                <img src="/src/assets/images/ourwork/New-Project-3-1024x1024.jpg" alt className="work-image" />
                                <div className="about-work">
                        ...
                        <div className="col-lg-4 project" data-category="ecommerce-development">
                            <div className="work-card">
                                <img src="/src/assets/images/ourwork/New-Project-1024x1024.jpg" alt className="work-image" />
                                <div className="about-work">
