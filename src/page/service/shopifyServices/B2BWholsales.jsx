                        ...
                        <div className="col-lg-7  colo-12  shopify-services-data">
                            <FadeInRight>
                                <div className="aximo-default-content">
                                    ...
                                    <h2 style={{ fontSize: '50px' }}>What is Shopify B2B and Wholesale?</h2>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-7 shopify-services-data">
                            <FadeInLeft>
                                <div className="aximo-default-content">
                                    <h2 style={{ fontSize: '50px' }}>Create a Custom Domain and B2B Storefront on Shopify</h2>
                    ...
                    <div className="row d-flex">
                        ...
                        <div className="col-lg-7  colo-12  shopify-services-data">
                            <FadeInRight>
                                <div className="aximo-default-content">
                                    {/* <h3 style={{ marginBottom: '16px' }}>Shopify CRO Agency - Shopify developer</h3> */}
                                    <h2 style={{ fontSize: '50px' }}>Custom Pricing, Order Limits & Flexible Payment Terms on Shopify</h2>
                                    <p className=" text-start">
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-7 shopify-services-data">
                            <FadeInLeft>
                                <div className="aximo-default-content">
                                    <h2 style={{ fontSize: '50px' }}>Streamlining Your B2B Account Area</h2>
                                    {/* <h3 style={{ marginBottom: '16px' }}>Custom Shopify themes tailored to your brand needs.</h3> */}
                                    <p>
                        ...
                        <div className="col-lg-7  colo-12  shopify-services-data">
                            <FadeInRight>
                                <div className="aximo-default-content">
                                    ...
                                    <p className=" text-start">While setting up a B2B or wholesale store on Shopify may seem complex, Codersh Web Services is here to simplify the process. Whether optimizing an existing store or launching a new one, our expert team can help streamline your wholesale operations and maximize efficiency.</p>
                                </div>
                            </FadeInRight>
                        </div>
                    </div>
            ...
            <div className="aximo-cta2-section aximo-section-padding extra-side-margin dark-bg mb-5" style={{ padding: "30px 0px" }}>
                <div className="container">
                    <div className="aximo-cta2-wrap shopify-services-data">
                        <h2>How Can Codersh Help You Build Your Shopify B2B Store?</h2>
                        <p className="mb-3">
