                        ...
                        <div className="col-lg-7  colo-12  shopify-services-data">
                            <FadeInRight>
                                <div className="aximo-default-content">
                                    <h2 style={{ fontSize: '50px' }}>Built for Your Revenue Goals, Powered by Expertise</h2>
                ...
                <div className="container">
                    <div className="row d-flex">
                        ...
                        <div className="col-lg-7  colo-12  shopify-services-data">
                            <FadeInRight>
                                <div className="aximo-default-content">
                                    <h2 style={{ fontSize: '50px' }}>Discovery, Strategy & Planning</h2>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-7 shopify-services-data">
                            <FadeInLeft>
                                <div className="aximo-default-content">
                                    <h2 style={{ fontSize: '50px' }}>CRO Optimized Design That Captivates & Converts</h2>
                                    <h3 style={{ marginBottom: '16px' }}>Stand out with designs as unique as your brand.
                                    </h3>
                                    <p>
                ...
                <div className="container">
                    <div className="row d-flex">
                        ...
                        <div className="col-lg-7  colo-12  shopify-services-data">
                            <FadeInRight>
                                <div className="aximo-default-content">
                                    <h2 style={{ fontSize: '50px' }}>Shopify Development Optimized for Results</h2>
                                    <h3 style={{ marginBottom: '16px' }}>Where design meets powerful functionality.</h3>
                                    <p>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-7 shopify-services-data">
                            <FadeInLeft>
                                <div className="aximo-default-content">
                                    <h2 style={{ fontSize: '50px' }}>Seamless Testing & Launch
                                    </h2>
                                    <h3 style={{ marginBottom: '16px' }}>Flawless execution for a stress-free launch.
                                    </h3>
                                    <p>
                ...
                <div className="container">
                    <div className="row d-flex">
                        ...
                        <div className="col-lg-7  colo-12  shopify-services-data">
                            <FadeInRight>
                                <div className="aximo-default-content">
                                    <h2 style={{ fontSize: '50px' }}>Beyond Launch: Optimization & Support</h2>
                                    <h3 style={{ marginBottom: '16px' }}>Your growth partner for the long haul.</h3>
                                    <p>
