          ...
          <div className="row d-flex">
            <div className="col-lg-5">
              <FadeInLeft className="aximo-content-thumb shopify-services-img">
                <img
                  src={ThumbImg1}
                  alt="Team working on Shopify Plus development strategy"
                />
              </FadeInLeft>
            </div>
            <div className="col-lg-7  colo-12  shopify-services-data">
              <FadeInRight>
                <div className="aximo-default-content">
                  <h2 className="mb-2">
                    Trusted by Merchants for Expertise, Growth, and Data-Driven
                    Innovation
                  </h2>
                  <p className="mb-4">
                    Codersh is a trusted Shopify Plus partner, delivering expert
                    e-commerce solutions since 2015. We work with global brands
                    and startups, offering custom UI/UX design, Shopify Plus
                    development, and data-driven solutions. Beyond store
                    optimization, we empower growth with in-house CRO, email
                    marketing, and SEO services. Partner with Codersh for
                    e-commerce solutions that drive success and fuel growth.
                  </p>
                  <FadeInUp className="aximo-btn-wrap2 mt-0  shopify-services-btn">
                    <Link
                      to="/contact-us"
                      className="iwt-button"
                      aria-label="Contact Codersh for Shopify Plus services"
                    >
                      Get In Touch
                    </Link>
                  </FadeInUp>
          ...
          <div className="row">
            <div className="col-lg-5 order-lg-2">
              <FadeInRight className="aximo-content-thumb shopify-services-img">
                <img
                  src={ThumbImg2}
                  alt="Shopify Plus platform with multiple store management"
                />
              </FadeInRight>
            </div>
            <div className="col-lg-7 shopify-services-data">
              <FadeInLeft>
                <div className="aximo-default-content">
                  <h2 className="mb-2">
                    Unlock Your Business Potential with Advanced Shopify Plus
                    Solutions
                  </h2>
                  {/* <h3 style={{ marginBottom: '16px' }}>Custom Shopify themes tailored to your brand needs.</h3> */}
                  <p className="mb-4">
                    Shopify Plus is an enterprise-level e-commerce platform
                    built for high-volume merchants, offering robust servers,
                    top-tier security, and scalable tools for efficient customer
                    service. Key benefits include customizable checkout, up to 9
                    expansion stores, advanced B2B features, detailed reporting,
                    and unlimited staff accounts. Shopify Plus enables
                    fast-growing brands to focus on customer experiences while
                    the platform effortlessly scales with their growth,
                    eliminating the need for constant infrastructure
                    maintenance.
                  </p>
                  <FadeInUp className="aximo-btn-wrap2 mt-0 shopify-services-btn">
                    <Link
                      to="/contact-us"
                      className="iwt-button"
                      aria-label="Start your Shopify Plus project with Codersh"
                    >
                      Start Your Journey!
                    </Link>
                  </FadeInUp>
          ...
          <div className="row d-flex">
            <div className="col-lg-5">
              <FadeInLeft className="aximo-content-thumb shopify-services-img">
                <img
                  src={ThumbImg3}
                  alt="Codersh experts delivering KPI-driven Shopify Plus solutions"
                />
              </FadeInLeft>
            </div>
            <div className="col-lg-7  colo-12  shopify-services-data">
              <FadeInRight>
                <div className="aximo-default-content">
                  <h2 className="mb-2">
                    Drive Sustainable Growth with Data-Driven Codersh
                    Partnership Programs on Shopify Plus
                  </h2>
                  <p className="mb-4">
                    Our Memberships unite designers, developers, and strategists
                    to deliver more than just technical skills—they provide
                    KPI-driven roadmaps aligned with your growth goals. Trusted
                    by leading Shopify Plus brands, our services are delivered
                    exclusively by our in-house experts.
                    <strong>Learn more about Codersh Memberships</strong> and
                    see how we can accelerate your e-commerce success.
                  </p>
                  <FadeInUp className="aximo-btn-wrap2 mt-0  shopify-services-btn">
                    <Link
                      to="/contact-us"
                      className="iwt-button"
                      aria-label="Connect with Codersh for Shopify Plus strategy"
                    >
                      Connect With Us
                    </Link>
                  </FadeInUp>
          ...
          <div className="row">
            <div className="col-lg-5 order-lg-2">
              <FadeInRight className="aximo-content-thumb shopify-services-img">
                <img
                  src={ThumbImg4}
                  alt="Data analytics tools for Shopify Plus growth strategy"
                />
              </FadeInRight>
            </div>
            <div className="col-lg-7 shopify-services-data">
              <FadeInLeft>
                <div className="aximo-default-content">
                  <h2 className="mb-2">
                    Analytics-powered growth strategies for Shopify Plus
                    businesses.
                  </h2>
                  {/* <h3 style={{ marginBottom: '16px' }}>Custom Shopify themes tailored to your brand needs.</h3> */}
                  <p className="mb-4">
                    We uses the latest frameworks and tools to deliver
                    high-quality, custom e-commerce solutions. Our experts in
                    HTML, CSS, JavaScript, and Liquid build or optimize themes
                    with tailored functionality and user-friendly design. We
                    prioritize speed, technical SEO, and compliance to ensure
                    seamless performance and easy content management for your
                    team.
                  </p>
                  ...
                  <FadeInUp className="aximo-btn-wrap2 mt-0  shopify-services-btn">
                    <Link
                      to="/contact-us"
                      className="iwt-button"
                      aria-label="Discuss Shopify Plus growth strategies with Codersh"
                    >
                      Get Started Today
                    </Link>
                  </FadeInUp>
          ...
          <div className="row d-flex">
            <div className="col-lg-5">
              <FadeInLeft className="aximo-content-thumb shopify-services-img">
                <img
                  src={ThumbImg5}
                  alt="Scalable Shopify Plus store interface"
                />
              </FadeInLeft>
            </div>
            <div className="col-lg-7  colo-12  shopify-services-data">
              <FadeInRight>
                <div className="aximo-default-content">
                  <h2 className="mb-2">
                    Creating future-ready Shopify stores with scalability in
                    mind.
                  </h2>
                  <p className="mb-4">
                    As Shopify Plus specialists, We helps brands launch new
                    stores or enhance existing ones with custom themes and
                    tailored features. We prioritize performance, speed, and
                    commercial goals, whether building from scratch or
                    optimizing templates. Our expert migration services ensure
                    smooth transitions from other platforms, making Shopify Plus
                    easy for both teams and customers. Expect visually stunning,
                    high-performing stores designed to drive growth.
                  </p>
                  <FadeInUp className="aximo-btn-wrap2 mt-0  shopify-services-btn">
                    <Link
                      to="/contact-us"
                      className="iwt-button"
                      aria-label="Contact Codersh to scale your Shopify Plus store"
                    >
                      Contact Us
                    </Link>
                  </FadeInUp>
