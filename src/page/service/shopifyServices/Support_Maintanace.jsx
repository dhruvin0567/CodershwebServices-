                        ...
                        <div className="col-lg-7  colo-12  shopify-services-data">
                            <FadeInRight>
                                <div className="aximo-default-content">
                                    <h3 style={{ marginBottom: '16px' }}>Shopify Development Retainer</h3>
                                    <h2 style={{ fontSize: '50px' }}>Leverage Conversions with Premium, Cutting-Edge Technology.</h2>
                                    <p>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-7 shopify-services-data">
                            <FadeInLeft>
                                <div className="aximo-default-content">
                                    <h3 style={{ marginBottom: '16px' }}>Shopify Retainer</h3>
                                    <h2 style={{ fontSize: '50px' }}>Captivate Shoppers With Premium Design</h2>
                                    <p>
                ...
                <div className="container">
                    <div className="row d-flex">
                        ...
                        <div className="col-lg-7  colo-12  shopify-services-data">
                            <FadeInRight>
                                <div className="aximo-default-content">
                                    <h3 style={{ marginBottom: '16px' }}>Shopify Optimization Retainer</h3>
                                    <h2 style={{ fontSize: '50px' }}>Conversion Rate Optimization</h2>
                                    <p>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-7 shopify-services-data">
                            <FadeInLeft>
                                <div className="aximo-default-content">
                                    <h3 style={{ marginBottom: '16px' }}>Technical Support & Shopify Support Services</h3>
                                    <h2 style={{ fontSize: '50px' }}>Your dedicated support team, ready when needed.</h2>
                                    <p>
