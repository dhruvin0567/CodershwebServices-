          ...
          <div className="row d-flex">
            <div className="col-lg-5">
              <FadeInLeft className="aximo-content-thumb shopify-services-img">
                <img
                  src={ThumbImg1}
                  alt="Shopify internationalization strategy infographic"
                />
              </FadeInLeft>
            </div>
      ...
      <div className="section aximo-project-page text-center dark-bg">
        <div className="container aximo-section-padding5 shopify-services-data">
          ...
          <p className="section-description light-text">
            ...
            nine expansion stores. Tailor content, pricing, and design for each
            market, and deliver localized shopping experiences that drive
            conversions. Ideal for high-growth businesses, Shopify Plus is built
            for seamless international expansion.
          </p>
        </div>
      </div>
                ...
                {faqData.faq1.map((faq) => (
                  <div key={faq.id} className="aximo-accordion-normal-item">
                    <div className="aximo-accordion-normal-icon">
                      <img
                        src={Check}
                        alt="Checkmark for verified Shopify Plus features"
                      />
                    </div>
                  ...
                  {featuresData.map((feature, index) => (
                    ...
                    >
                      ...
                      >
                        <img
                          src={feature.img}
                          alt={`Integration logo for Shopify`}
                        />
                      </div>
                    </FadeInStagger>
                  ))}
