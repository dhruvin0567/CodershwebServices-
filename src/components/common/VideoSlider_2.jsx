...
function VideoSlider_2() {
    ...
    return (
        <div>
            <FadeInStagger>
                <div className="review-section text-center pt-5">
                    <div className="container py-5">
                        <div className='mb-5'>
                            <h2>Our Client's Reviews</h2>
                            <p className='brand-text'>
                                We are very proud of the service we provide and stand by every product we carry. <br /> See our testimonials
