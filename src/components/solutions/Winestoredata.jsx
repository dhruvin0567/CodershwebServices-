        ...
        <div>
                    ...
                    >
                        <SwiperSlide>
                            <div className="aximo-project-thumb wow fadeInUpX" style={{ cursor: "grab" }} data-wow-delay="0.1s">
                                <img src="src/assets/images/Images_2/artisan-f-p.webp" alt="Credi Coach" />
                        ...
                        <SwiperSlide>
                            <div className="aximo-project-thumb wow fadeInUpX" style={{ cursor: "grab" }} data-wow-delay="0.2s">
                                <img src="src/assets/images/Images_2/asterley-bros-f-p.webp" alt="Credit Saint" />
                                <div className="aximo-project-wrap">
                                    <div className="aximo-project-data">
                                        <Link to="#">
                                            <h3>Credit Saint</h3>
                        ...
                        <SwiperSlide>
                            <div className="aximo-project-thumb wow fadeInUpX" style={{ cursor: "grab" }} data-wow-delay="0.3s">
                                <img src="src/assets/images/Images_2/bone-f-p.webp" alt="Credit 101" />
                                <div className="aximo-project-wrap">
                                    <div className="aximo-project-data">
                                        <Link to="#">
                                            <h3>Credit 101</h3>
                        ...
                        <SwiperSlide>
                            <div className="aximo-project-thumb wow fadeInUpX" style={{ cursor: "grab" }} data-wow-delay="0.4s">
                                <img src="src/assets/images/Images_2/Claudine-f-p.webp" alt="Framework Credit" />
                                <div className="aximo-project-wrap">
                                    <div className="aximo-project-data">
                                        <Link to="#">
                        ...
                        <SwiperSlide>
                            <div className="aximo-project-thumb wow fadeInUpX" style={{ cursor: "grab" }} data-wow-delay="0.5s">
                                <img src="src/assets/images/Images_2/Double-Dutch-f-p.webp" alt="Premier Credit" />
                                <div className="aximo-project-wrap">
                                    <div className="aximo-project-data">
                                        <Link to="#">
                        ...
                        <SwiperSlide>
                            <div className="aximo-project-thumb wow fadeInUpX" data-wow-delay="0.6s">
                                <img src="src/assets/images/Images_2/gattertop-f-p.webp" alt="SD Capital" />
                                <div className="aximo-project-wrap">
                                    <div className="aximo-project-data">
                                        <Link to="#">
                                            <h3>SD Capital</h3>
                        ...
                        <SwiperSlide>
                            <div className="aximo-project-thumb wow fadeInUpX" data-wow-delay="0.7s">
                                <img src="src/assets/images/Images_2/liberation-f-p.webp" alt="Stellar Credit" />
                                <div className="aximo-project-wrap">
                                    <div className="aximo-project-data">
                                        <Link to="#">
                        ...
                        <SwiperSlide>
                            <div className="aximo-project-thumb wow fadeInUpX" data-wow-delay="0.7s">
                                <img src="src/assets/images/Images_2/madamef-f-p.webp" alt="Stellar Credit" />
                                <div className="aximo-project-wrap">
                                    <div className="aximo-project-data">
                                        <Link to="#">
                                            <h3>Stellar Credit</h3>
                        ...
                        <SwiperSlide>
                            <div className="aximo-project-thumb wow fadeInUpX" data-wow-delay="0.7s">
                                <img src="src/assets/images/Images_2/negroni-soc-f-p.webp" alt="Stellar Credit" />
                                <div className="aximo-project-wrap">
                                    <div className="aximo-project-data">
                                        <Link to="#">
                                            <h3>Stellar Credit</h3>
                        ...
                        <SwiperSlide>
                            <div className="aximo-project-thumb wow fadeInUpX" data-wow-delay="0.7s">
                                <img src="src/assets/images/Images_2/van-hunks-f-p.webp" alt="Stellar Credit" />
                                <div className="aximo-project-wrap">
                                    <div className="aximo-project-data">
                                        <Link to="#">
                                            <h3>Stellar Credit</h3>
            ...
            <div className="section aximo-project-page logo-slider dark-bg">
                <div className="container border-top py-5">
                    ...
                    >
                        <SwiperSlide>
                            <img src="src/assets/images/Images_2/bone-logo.webp" alt="" />
                        </SwiperSlide>
                        <SwiperSlide>
                            <img src="src/assets/images/Images_2/Claudine-logo.webp" alt="" />
                        </SwiperSlide>
                        <SwiperSlide>
                            <img src="src/assets/images/Images_2/artisan-logo.webp" alt="" />
                        </SwiperSlide>
                        <SwiperSlide>
                            <img src="src/assets/images/Images_2/asterley-bros.webp" alt="" />
                        </SwiperSlide>
                        <SwiperSlide>
                            <img src="src/assets/images/Images_2/Double-Dutch-logo.webp" alt="" />
                        </SwiperSlide>
                        <SwiperSlide>
                            <img src="src/assets/images/Images_2/gattertop-logo.webp" alt="" />
                        </SwiperSlide>
                        <SwiperSlide>
                            <img src="src/assets/images/Images_2/liberation-logo.webp" alt="" />
                        </SwiperSlide>
                        <SwiperSlide>
                            <img src="src/assets/images/Images_2/madamef-logo.webp" alt="" />
                        </SwiperSlide>
                        <SwiperSlide>
                            <img src="src/assets/images/Images_2/van-hunks.webp" alt="" />
                        </SwiperSlide>
                    </Swiper>
                </div>
            </div>
