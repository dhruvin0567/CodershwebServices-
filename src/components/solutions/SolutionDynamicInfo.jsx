...
function SolutionDynamicInfo({
  ...
  return (
    <section aria-label="Credit Repair Website Information Section">
      ...
      <div className={sectionClass}>
        <div className="container aximo-section-padding5">
            ...
            <span className="aximo-title-animation">
              ...
              {iconImage && (
                <span className="aximo-title-icon mx-2">
                  <img src={iconImage} alt="Star icon representing growth" />
                </span>
              )}
            </span>
            <br />
          ...
          <p
            className={`section-description ${textClass}`}
