...
function CaseStudiesdataStatic() {
  return (
    <section
      className="section aximo-section-padding2 aximo-project-page"
        ...
        <div className="row">
          {caseStudies.map((caseStudy, index) => (
            <FadeInStagger
              ...
              index={index}
            >
              <article role="listitem" aria-label={caseStudy.title}>
                <PortfolioCard blog={{ ...caseStudy, alt: caseStudy.alt }} />
              </article>
            </FadeInStagger>
          ))}
        </div>
